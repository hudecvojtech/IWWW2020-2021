...
start DATE NOT NULL, end DATE NOT NULL, CATEGORY_id_category INTEGER NOT NULL, PRIMARY KEY(id_event_calendar),
...
CREATE TABLE calendars_events(CALENDAR_id_calendar INTEGER NOT NULL, EVENT_CALENDAR_id_event_calendar INTEGER NOT NULL, owner VARCHAR(255) NOT NULL,
 FOREIGN KEY(CALENDAR_id_calendar) REFERENCES calendar(id_calendar), FOREIGN KEY(EVENT_CALENDAR_id_event_calendar) REFERENCES event_calendar(id_event_calendar));

INSERT INTO avatar(id_avatar, path) VALUES(1, 'default-avatar.png');
INSERT INTO category(name) VALUES('Meeting');
INSERT INTO category(name) VALUES('Long');
